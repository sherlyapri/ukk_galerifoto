...
<body>
    ...
    ?>
                <div class="category-item">
                    ...
                    <!-- Tombol Hapus -->
                    <form action="hapus_album.php" method="POST" style="display:inline;">
                        <input type="hidden" name="albumid" value="<?php echo $data['albumid']; ?>">
                        <button type="submit" name="hapus" class="btn-hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus album ini?');">Hapus</button>
                    </form>
                </div>
    <?php
            }
